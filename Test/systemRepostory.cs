...
namespace c_Airline
{
    class SystemRepostory
    {
        ...
        static readonly string connectionString = "Data Source=DESKTOP-KPT7EFB;Initial Catalog=AirLine Company;Integrated Security=True;";
        ...
        public static void MainMenuEntity()
        {
            ...
            "Route", "Flights", "Transaction","Back",
              }));
        ...
        public static void Login()
        {
           ...
           .AddChoices(new[] {
            ...
            "1-Show Upcoming Flights", "2-BooK Flight", "3-Back", }));
                ...
                {
                    List<int> fl = Booker.UpcomingFlight();
