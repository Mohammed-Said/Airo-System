...
namespace c_Airline
{
  public class Transaction : ICrudOperation
  {
    ...
    public bool Create()
    {
      try
      {
        ...
        do
        {
          ...
          if (IscreatedFunc(_AirlineID, ref Iscreated, ref _amount, ref _date)) { }
    ...
    public bool Edit()
    {
...

      {
        ...
        do
        {
          ...
          //To Ensure That ID Transactions is in our DB and Then the update process 
    ...
    private bool IscreatedFunc(int inputID, ref bool Iscreated, ref int _amount, ref DateTime _date)
    {
    ...
    private bool IsRowUpdated(ref int airlineId, ref int TransID, ref bool isIDAieUpdated, ref int _amount, ref DateTime _date)
    {
      ...
      if (IsIDExist(airlineId))
      {
        ...
        command.Parameters.AddWithValue("@InputID", TransID);
    ...
    private bool IsUpdated(ref int inputID, ref bool isUpdated)
    {
      ...
      if (IsIDTransExist(inputID))
      {
        ...
        do
        {
          ...
          //To Ensure That ID _AirlineID is in our DB and create That spcific Row
          if (IsRowUpdated(ref _AirlineID, ref inputID, ref isIDAieUpdated, ref _amount, ref _date)) { }
