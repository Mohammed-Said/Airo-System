...
namespace c_Airline
{
  class Route : ICrudOperation
  {
    ...
    public bool Edit()
    {
      try
      {
        ...
        do
        {
          ...
          if (IsUpdated(InputID, ref isUpdated)) { }
    ...
    //Function That checked if Row is Updated 
    private bool IsUpdated(int inputID, ref bool isUpdated)
    {
    ...
    //Function That checked if Rows Are getten 
